...
//  SlotMachine
//
//  Created by Willie Strickland on 4/25/15.
...
class ViewController: UIViewController {
    ...
    func setupContainerViews()  {
        ...
        self.fourthContainer = UIView(frame: CGRect(x: self.view.bounds.origin.x + kMarginForView, y: self.view.bounds.origin.y, width: self.view.bounds.width - (kMarginForView * 2), height: self.view.bounds.height * kSixth))
